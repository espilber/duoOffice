...
export const strings = {
  zh: {
    ...
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'duoOffice Projects',
    cloudSubtitle: '在网页端用 duoOffice AI 创建的项目。编辑在浏览器中继续——点击任意项目即可打开。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '登录 duoOffice 账号，查看你在网页端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    noContent: '（无内容）',
    // Account
    accountduoOffice: 'duoOffice 账号',
    account: '账号',
    login: '登录',
    loginduoOffice: '登录 duoOffice 账号',
    loggedIn: '已登录',
    loggedInduoOffice: '已登录 duoOffice',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 duoOffice,请检查网络或代理设置',
    ...
    setAiduoOfficeHint: '使用 duoOffice 账号登录，无需 API key。',
    setAiByokNote: '对话使用你自己的 key；网页搜索、生图等云工具仍需登录 duoOffice。',
    setAiSave: '保存',
    setAiSaved: '已保存',
    setAiTest: '测试连接',
    setAiTesting: '测试中…',
    setAiTestOk: '连接成功',
    setAiTestFail: '连接失败',
    setAiGskTools: 'duoOffice 云工具',
    setAiGskToolsDesc:
      '网页搜索、AI 生图、媒体分析经 duoOffice 云端并消耗积分；关闭后生图与媒体分析不可用，搜索改用免费来源。',
    setGithub: '开源项目',
    ...
    onbCredits: '活跃贡献者可获得 **1,000+ duoOffice 积分**',
    ...
    onbNote3: 'AI 功能可能消耗 duoOffice 积分。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'Projects created on the web with duoOffice AI. Editing continues in your browser — click any project to open it.',
    ...
    cloudLoginHint: 'Sign in to your duoOffice account to see projects you created on the web.',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountduoOffice: 'duoOffice Account',
    account: 'Account',
    login: 'Sign in',
    loginduoOffice: 'Sign in with duoOffice',
    loggedIn: 'Signed in',
    loggedInduoOffice: 'Signed in to duoOffice',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach duoOffice — check your network or proxy settings',
    ...
    setAiduoOfficeHint: 'Uses your duoOffice sign-in; no API key needed.',
    setAiByokNote:
      'Chats use your own key; cloud tools (web search, image generation) still require the duoOffice sign-in.',
    setAiSave: 'Save',
    setAiSaved: 'Saved',
    ...
    setAiGskTools: 'duoOffice cloud tools',
    setAiGskToolsDesc:
      'Web search, AI image generation and media analysis run through duoOffice and use credits; when off, image tools are unavailable and search uses free sources.',
    ...
    onbCredits: 'Active contributors get **1,000+ duoOffice credits**',
    ...
    onbNote3: 'AI features may consume duoOffice credits.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'Web で duoOffice AI を使って作成したプロジェクト。編集はブラウザで続行します。クリックで開きます。',
    ...
    cloudRefresh: '更新',
    cloudLoginHint:
      'duoOffice アカウントにサインインすると、Web で作成したプロジェクトを表示できます。',
    ...
    noContent: '（内容なし）',
    // Account
    accountduoOffice: 'duoOffice アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginduoOffice: 'duoOffice アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInduoOffice: 'duoOffice にサインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError:
      'duoOffice に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    setAiduoOfficeHint: 'duoOffice アカウントでサインインするため、API キーは不要です。',
    setAiByokNote:
      'チャットは自分のキーを使用します。ウェブ検索や画像生成などのクラウドツールには duoOffice へのサインインが必要です。',
    setAiSave: '保存',
    setAiSaved: '保存しました',
    setAiTest: '接続テスト',
    setAiTesting: 'テスト中…',
    ...
    setAiGskTools: 'duoOffice クラウドツール',
    setAiGskToolsDesc:
      'ウェブ検索・AI 画像生成・メディア分析は duoOffice クラウド経由でクレジットを消費します。オフにすると画像ツールは使えず、検索は無料ソースを使用します。',
    setGithub: 'オープンソース',
    ...
    onbCredits: 'アクティブな貢献者への特典 **1,000+ duoOffice クレジット**',
    ...
    onbNote3: 'AI 機能は duoOffice クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'duoOffice AI로 웹에서 만든 프로젝트입니다. 편집은 브라우저에서 계속됩니다. 프로젝트를 클릭하면 열립니다.',
    ...
    cloudRefresh: '새로고침',
    cloudLoginHint: 'duoOffice 계정에 로그인하면 웹에서 만든 프로젝트를 볼 수 있습니다.',
    ...
    noContent: '(내용 없음)',
    // Account
    accountduoOffice: 'duoOffice 계정',
    account: '계정',
    login: '로그인',
    loginduoOffice: 'duoOffice 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInduoOffice: 'duoOffice에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'duoOffice에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    setAiduoOfficeHint: 'duoOffice 로그인으로 사용하며 API 키가 필요 없습니다.',
    setAiByokNote:
      '대화는 자신의 키를 사용합니다. 웹 검색·이미지 생성 등 클라우드 도구는 여전히 duoOffice 로그인이 필요합니다.',
    setAiSave: '저장',
    setAiSaved: '저장됨',
    setAiTest: '연결 테스트',
    setAiTesting: '테스트 중…',
    setAiTestOk: '연결 성공',
    setAiTestFail: '연결 실패',
    setAiGskTools: 'duoOffice 클라우드 도구',
    setAiGskToolsDesc:
      '웹 검색·AI 이미지 생성·미디어 분석은 duoOffice 클라우드를 거치며 크레딧을 사용합니다. 끄면 이미지 도구를 사용할 수 없고 검색은 무료 소스를 사용합니다.',
    setGithub: '오픈 소스',
    ...
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ duoOffice 크레딧**',
    ...
    onbNote3: 'AI 기능은 duoOffice 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      "Projets créés sur le web avec duoOffice AI. L'édition continue dans votre navigateur — cliquez sur un projet pour l'ouvrir.",
    ...
    cloudLoginHint:
      'Connectez-vous à votre compte duoOffice pour voir les projets créés sur le web.',
    ...
    noContent: '(vide)',
    // Account
    accountduoOffice: 'Compte duoOffice',
    account: 'Compte',
    login: 'Se connecter',
    loginduoOffice: 'Se connecter avec duoOffice',
    loggedIn: 'Connecté',
    loggedInduoOffice: 'Connecté à duoOffice',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre duoOffice — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    setAiduoOfficeHint: 'Utilise votre connexion duoOffice ; aucune clé API requise.',
    setAiByokNote:
      "Les conversations utilisent votre propre clé ; les outils cloud (recherche web, génération d'images) nécessitent toujours la connexion duoOffice.",
    ...
    setAiGskTools: 'Outils cloud duoOffice',
    setAiGskToolsDesc:
      "Recherche web, génération d'images et analyse de médias passent par duoOffice et consomment des crédits ; désactivé, les outils d'image sont indisponibles et la recherche utilise des sources gratuites.",
    setGithub: 'Open source',
    ...
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits duoOffice**',
    ...
    onbNote3: 'Les fonctions IA peuvent consommer des crédits duoOffice.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'Mit duoOffice AI im Web erstellte Projekte. Die Bearbeitung läuft im Browser weiter – klicken Sie auf ein Projekt, um es zu öffnen.',
    ...
    cloudLoginHint:
      'Melden Sie sich bei Ihrem duoOffice-Konto an, um Ihre im Web erstellten Projekte zu sehen.',
    ...
    noContent: '(leer)',
    // Account
    accountduoOffice: 'duoOffice-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginduoOffice: 'Mit duoOffice anmelden',
    loggedIn: 'Angemeldet',
    loggedInduoOffice: 'Bei duoOffice angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      'duoOffice ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    setAiduoOfficeHint: 'Nutzt Ihre duoOffice-Anmeldung; kein API-Schlüssel nötig.',
    setAiByokNote:
      'Chats verwenden Ihren eigenen Schlüssel; Cloud-Tools (Websuche, Bilderzeugung) erfordern weiterhin die duoOffice-Anmeldung.',
    setAiSave: 'Speichern',
    ...
    setAiGskTools: 'duoOffice-Cloud-Tools',
    setAiGskToolsDesc:
      'Websuche, KI-Bilderzeugung und Medienanalyse laufen über duoOffice und verbrauchen Guthaben; ausgeschaltet sind Bildtools nicht verfügbar und die Suche nutzt freie Quellen.',
    setGithub: 'Open Source',
    ...
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ duoOffice-Guthaben**',
    ...
    onbNote3: 'KI-Funktionen können duoOffice-Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'Proyectos creados en la web con duoOffice AI. La edición continúa en tu navegador: haz clic en un proyecto para abrirlo.',
    ...
    cloudLoginHint:
      'Inicia sesión en tu cuenta de duoOffice para ver los proyectos creados en la web.',
    ...
    noContent: '(vacío)',
    // Account
    accountduoOffice: 'Cuenta de duoOffice',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginduoOffice: 'Iniciar sesión con duoOffice',
    loggedIn: 'Sesión iniciada',
    loggedInduoOffice: 'Sesión iniciada en duoOffice',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con duoOffice — compruebe su red o la configuración del proxy',
    ...
    setAiduoOfficeHint: 'Usa tu inicio de sesión de duoOffice; no se necesita clave de API.',
    setAiByokNote:
      'Los chats usan tu propia clave; las herramientas en la nube (búsqueda web, generación de imágenes) siguen requiriendo el inicio de sesión de duoOffice.',
    setAiSave: 'Guardar',
    setAiSaved: 'Guardado',
    ...
    setAiGskTools: 'Herramientas en la nube de duoOffice',
    setAiGskToolsDesc:
      'La búsqueda web, la generación de imágenes y el análisis de medios pasan por duoOffice y consumen créditos; desactivado, las herramientas de imagen no están disponibles y la búsqueda usa fuentes gratuitas.',
    ...
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de duoOffice**',
    ...
    onbNote3: 'Las funciones de IA pueden consumir créditos de duoOffice.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'โปรเจกต์ที่สร้างบนเว็บด้วย duoOffice AI แก้ไขต่อได้ในเบราว์เซอร์ — คลิกโปรเจกต์เพื่อเปิด',
    ...
    cloudRefresh: 'รีเฟรช',
    cloudLoginHint: 'ลงชื่อเข้าใช้บัญชี duoOffice เพื่อดูโปรเจกต์ที่คุณสร้างบนเว็บ',
    ...
    // Account
    accountduoOffice: 'บัญชี duoOffice',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginduoOffice: 'ลงชื่อเข้าใช้ด้วย duoOffice',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInduoOffice: 'ลงชื่อเข้าใช้ duoOffice แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ duoOffice ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    setAiduoOfficeHint: 'ใช้การลงชื่อเข้าใช้ duoOffice ไม่ต้องใช้คีย์ API',
    setAiByokNote:
      'แชทใช้คีย์ของคุณเอง เครื่องมือคลาวด์ (ค้นเว็บ สร้างภาพ) ยังต้องลงชื่อเข้าใช้ duoOffice',
    setAiSave: 'บันทึก',
    ...
    setAiGskTools: 'เครื่องมือคลาวด์ duoOffice',
    setAiGskToolsDesc:
      'ค้นเว็บ สร้างภาพ AI และวิเคราะห์สื่อผ่านคลาวด์ duoOffice และใช้เครดิต ปิดแล้วเครื่องมือภาพจะใช้ไม่ได้ และการค้นหาใช้แหล่งฟรี',
    ...
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต duoOffice กว่า 1,000**',
    ...
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต duoOffice',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'Proyek yang dibuat di web dengan duoOffice AI. Pengeditan berlanjut di browser — klik proyek untuk membukanya.',
    ...
    cloudLoginHint: 'Masuk ke akun duoOffice untuk melihat proyek yang Anda buat di web.',
    ...
    noContent: '(kosong)',
    // Account
    accountduoOffice: 'Akun duoOffice',
    account: 'Akun',
    login: 'Masuk',
    loginduoOffice: 'Masuk dengan duoOffice',
    loggedIn: 'Sudah masuk',
    loggedInduoOffice: 'Sudah masuk ke duoOffice',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke duoOffice — periksa jaringan atau pengaturan proxy Anda',
    ...
    setAiduoOfficeHint: 'Menggunakan login duoOffice; tanpa kunci API.',
    setAiByokNote:
      'Obrolan memakai kunci Anda sendiri; alat cloud (pencarian web, pembuatan gambar) tetap memerlukan login duoOffice.',
    setAiSave: 'Simpan',
    ...
    setAiGskTools: 'Alat cloud duoOffice',
    setAiGskToolsDesc:
      'Pencarian web, pembuatan gambar AI, dan analisis media berjalan lewat duoOffice dan memakai kredit; jika dimatikan, alat gambar tidak tersedia dan pencarian memakai sumber gratis.',
    ...
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit duoOffice**',
    ...
    onbNote3: 'Fitur AI dapat menggunakan kredit duoOffice.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'Проекты, созданные в вебе с duoOffice AI. Редактирование продолжается в браузере — нажмите на проект, чтобы открыть его.',
    ...
    cloudLoginHint: 'Войдите в аккаунт duoOffice, чтобы увидеть проекты, созданные в вебе.',
    ...
    noContent: '(пусто)',
    // Account
    accountduoOffice: 'Учётная запись duoOffice',
    account: 'Учётная запись',
    login: 'Войти',
    loginduoOffice: 'Войти через duoOffice',
    loggedIn: 'Вход выполнен',
    loggedInduoOffice: 'Выполнен вход в duoOffice',
    ...
    loginNetworkError: 'Не удаётся подключиться к duoOffice — проверьте сеть или настройки прокси',
    ...
    setAiduoOfficeHint: 'Использует вход в duoOffice; ключ API не нужен.',
    setAiByokNote:
      'Чаты используют ваш собственный ключ; облачные инструменты (веб-поиск, генерация изображений) по-прежнему требуют входа в duoOffice.',
    setAiSave: 'Сохранить',
    ...
    setAiGskTools: 'Облачные инструменты duoOffice',
    setAiGskToolsDesc:
      'Веб-поиск, генерация изображений и анализ медиа идут через duoOffice и расходуют кредиты; при отключении инструменты изображений недоступны, а поиск использует бесплатные источники.',
    ...
    onbCredits: 'Активные участники получают **1000+ кредитов duoOffice**',
    ...
    onbNote3: 'Функции ИИ могут расходовать кредиты duoOffice.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'مشاريع أُنشئت على الويب باستخدام duoOffice AI. يستمر التحرير في المتصفح — انقر على أي مشروع لفتحه.',
    ...
    cloudRefresh: 'تحديث',
    cloudLoginHint: 'سجّل الدخول إلى حساب duoOffice لعرض المشاريع التي أنشأتها على الويب.',
    ...
    noContent: '(فارغ)',
    // Account
    accountduoOffice: 'حساب duoOffice',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginduoOffice: 'تسجيل الدخول باستخدام duoOffice',
    loggedIn: 'تم تسجيل الدخول',
    loggedInduoOffice: 'تم تسجيل الدخول إلى duoOffice',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ duoOffice — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    setAiduoOfficeHint: 'يستخدم تسجيل الدخول إلى duoOffice؛ لا حاجة لمفتاح API.',
    setAiByokNote:
      'تستخدم المحادثات مفتاحك الخاص؛ أدوات السحابة (بحث الويب وتوليد الصور) ما زالت تتطلب تسجيل الدخول إلى duoOffice.',
    setAiSave: 'حفظ',
    setAiSaved: 'تم الحفظ',
    ...
    setAiGskTools: 'أدوات duoOffice السحابية',
    setAiGskToolsDesc:
      'يمر بحث الويب وتوليد الصور وتحليل الوسائط عبر سحابة duoOffice ويستهلك الرصيد؛ عند الإيقاف تصبح أدوات الصور غير متاحة ويستخدم البحث مصادر مجانية.',
    ...
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة duoOffice**',
    ...
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة duoOffice.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'Projetos criados na web com o duoOffice AI. A edição continua no navegador — clique em um projeto para abri-lo.',
    ...
    cloudLoginHint: 'Entre na sua conta duoOffice para ver os projetos criados na web.',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountduoOffice: 'Conta duoOffice',
    account: 'Conta',
    login: 'Entrar',
    loginduoOffice: 'Entrar com a duoOffice',
    loggedIn: 'Conectado',
    loggedInduoOffice: 'Conectado à duoOffice',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao duoOffice — verifique sua rede ou as configurações de proxy',
    ...
    setAiduoOfficeHint: 'Usa seu login duoOffice; nenhuma chave de API necessária.',
    setAiByokNote:
      'Os chats usam sua própria chave; as ferramentas na nuvem (busca na web, geração de imagens) ainda exigem o login duoOffice.',
    setAiSave: 'Salvar',
    setAiSaved: 'Salvo',
    ...
    setAiGskTools: 'Ferramentas na nuvem duoOffice',
    setAiGskToolsDesc:
      'Busca na web, geração de imagens e análise de mídia passam pela duoOffice e consomem créditos; desligado, as ferramentas de imagem ficam indisponíveis e a busca usa fontes gratuitas.',
    ...
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos duoOffice**',
    ...
    onbNote3: 'Os recursos de IA podem consumir créditos duoOffice.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'Progetti creati sul web con duoOffice AI. La modifica continua nel browser: fai clic su un progetto per aprirlo.',
    ...
    cloudLoginHint: 'Accedi al tuo account duoOffice per vedere i progetti creati sul web.',
    ...
    noContent: '(vuoto)',
    accountduoOffice: 'Account duoOffice',
    account: 'Account',
    login: 'Accedi',
    loginduoOffice: 'Accedi con duoOffice',
    loggedIn: 'Accesso effettuato',
    loggedInduoOffice: 'Accesso effettuato a duoOffice',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere duoOffice — controlla la rete o le impostazioni del proxy',
    ...
    setAiduoOfficeHint: 'Usa il tuo accesso duoOffice; nessuna chiave API richiesta.',
    setAiByokNote:
      "Le chat usano la tua chiave; gli strumenti cloud (ricerca web, generazione immagini) richiedono comunque l'accesso duoOffice.",
    setAiSave: 'Salva',
    setAiSaved: 'Salvato',
    ...
    setAiGskTools: 'Strumenti cloud duoOffice',
    setAiGskToolsDesc:
      'Ricerca web, generazione di immagini e analisi dei media passano da duoOffice e consumano crediti; se disattivato, gli strumenti immagine non sono disponibili e la ricerca usa fonti gratuite.',
    setGithub: 'Open source',
    ...
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti duoOffice**',
    ...
    onbNote3: 'Le funzioni IA possono consumare crediti duoOffice.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'Projekty utworzone w sieci za pomocą duoOffice AI. Edycja jest kontynuowana w przeglądarce — kliknij projekt, aby go otworzyć.',
    ...
    cloudLoginHint: 'Zaloguj się na konto duoOffice, aby zobaczyć projekty utworzone w sieci.',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountduoOffice: 'Konto duoOffice',
    account: 'Konto',
    login: 'Zaloguj się',
    loginduoOffice: 'Zaloguj się przez duoOffice',
    loggedIn: 'Zalogowano',
    loggedInduoOffice: 'Zalogowano do duoOffice',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z duoOffice — sprawdź sieć lub ustawienia proxy',
    ...
    setAiduoOfficeHint: 'Korzysta z logowania duoOffice; klucz API nie jest potrzebny.',
    setAiByokNote:
      'Czaty używają Twojego klucza; narzędzia w chmurze (wyszukiwanie, generowanie obrazów) nadal wymagają logowania duoOffice.',
    setAiSave: 'Zapisz',
    setAiSaved: 'Zapisano',
    ...
    setAiGskTools: 'Narzędzia chmurowe duoOffice',
    setAiGskToolsDesc:
      'Wyszukiwanie w sieci, generowanie obrazów AI i analiza mediów przechodzą przez duoOffice i zużywają kredyty; po wyłączeniu narzędzia obrazów są niedostępne, a wyszukiwanie korzysta z darmowych źródeł.',
    setGithub: 'Open source',
    ...
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów duoOffice**',
    ...
    onbNote3: 'Funkcje AI mogą zużywać kredyty duoOffice.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'Projecten gemaakt op het web met duoOffice AI. Bewerken gaat verder in je browser — klik op een project om het te openen.',
    ...
    cloudLoginHint:
      'Log in op je duoOffice-account om projecten te zien die je op het web hebt gemaakt.',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginduoOffice: 'Inloggen met duoOffice',
    loggedIn: 'Ingelogd',
    loggedInduoOffice: 'Ingelogd bij duoOffice',
    ...
    loginNetworkError: 'Kan duoOffice niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    setAiduoOfficeHint: 'Gebruikt je duoOffice-login; geen API-sleutel nodig.',
    setAiByokNote:
      'Chats gebruiken je eigen sleutel; cloudtools (webzoeken, beeldgeneratie) vereisen nog steeds de duoOffice-login.',
    setAiSave: 'Opslaan',
    ...
    setAiGskTools: 'duoOffice-cloudtools',
    setAiGskToolsDesc:
      'Webzoeken, AI-beeldgeneratie en media-analyse lopen via duoOffice en verbruiken tegoed; uitgeschakeld zijn beeldtools niet beschikbaar en gebruikt zoeken gratis bronnen.',
    setGithub: 'Open source',
    ...
    onbCredits: 'Actieve bijdragers krijgen **1.000+ duoOffice-credits**',
    ...
    onbNote3: 'AI-functies kunnen duoOffice-credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'Projek yang dicipta di web dengan duoOffice AI. Penyuntingan diteruskan dalam pelayar — klik projek untuk membukanya.',
    ...
    cloudLoginHint: 'Log masuk ke akaun duoOffice untuk melihat projek yang anda cipta di web.',
    ...
    noContent: '(kosong)',
    accountduoOffice: 'Akaun duoOffice',
    account: 'Akaun',
    login: 'Log masuk',
    loginduoOffice: 'Log masuk dengan duoOffice',
    loggedIn: 'Telah log masuk',
    loggedInduoOffice: 'Telah log masuk ke duoOffice',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke duoOffice — semak rangkaian atau tetapan proksi anda',
    ...
    setAiduoOfficeHint: 'Menggunakan log masuk duoOffice; tiada kunci API diperlukan.',
    setAiByokNote:
      'Sembang menggunakan kunci anda sendiri; alat awan (carian web, penjanaan imej) masih memerlukan log masuk duoOffice.',
    setAiSave: 'Simpan',
    setAiSaved: 'Disimpan',
    ...
    setAiGskTools: 'Alat awan duoOffice',
    setAiGskToolsDesc:
      'Carian web, penjanaan imej AI dan analisis media melalui awan duoOffice dan menggunakan kredit; jika dimatikan, alat imej tidak tersedia dan carian menggunakan sumber percuma.',
    setGithub: 'Sumber Terbuka',
    starOnGitHub: 'Beri Bintang di GitHub',
    starPromptTitle: 'Suka GenOffice?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan GenOffice',
    ...
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit duoOffice**',
    ...
    onbNote3: 'Ciri AI mungkin menggunakan kredit duoOffice.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'פרויקטים שנוצרו באינטרנט עם duoOffice AI. העריכה נמשכת בדפדפן — לחצו על פרויקט כדי לפתוח אותו.',
    ...
    cloudRefresh: 'רענון',
    cloudLoginHint: 'התחברו לחשבון duoOffice כדי לראות פרויקטים שיצרתם באתר.',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountduoOffice: 'חשבון duoOffice',
    account: 'חשבון',
    login: 'התחברות',
    loginduoOffice: 'התחברות עם duoOffice',
    loggedIn: 'מחובר',
    loggedInduoOffice: 'מחובר ל-duoOffice',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-duoOffice — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    setAiduoOfficeHint: 'משתמש בכניסת duoOffice שלך; אין צורך במפתח API.',
    setAiByokNote:
      'שיחות משתמשות במפתח שלך; כלי ענן (חיפוש ברשת, יצירת תמונות) עדיין דורשים כניסת duoOffice.',
    setAiSave: 'שמירה',
    setAiSaved: 'נשמר',
    ...
    setAiGskTools: 'כלי הענן של duoOffice',
    setAiGskToolsDesc:
      'חיפוש ברשת, יצירת תמונות וניתוח מדיה עוברים דרך duoOffice וצורכים קרדיטים; בכיבוי, כלי התמונות אינם זמינים והחיפוש משתמש במקורות חינמיים.',
    setGithub: 'קוד פתוח',
    ...
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות duoOffice**',
    ...
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של duoOffice.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    navCloud: 'duoOffice Projects',
    cloudSubtitle:
      'duoOffice AI के साथ वेब पर बनाए गए प्रोजेक्ट। संपादन ब्राउज़र में जारी रहता है — खोलने के लिए किसी प्रोजेक्ट पर क्लिक करें।',
    ...
    cloudLoginHint: 'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने duoOffice खाते में साइन इन करें।',
    ...
    noContent: '(खाली)',
    accountduoOffice: 'duoOffice खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginduoOffice: 'duoOffice से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInduoOffice: 'duoOffice में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'duoOffice से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    setAiduoOfficeHint: 'आपके duoOffice साइन-इन का उपयोग करता है; API कुंजी की आवश्यकता नहीं।',
    setAiByokNote:
      'चैट आपकी अपनी कुंजी का उपयोग करती हैं; क्लाउड टूल (वेब खोज, छवि निर्माण) के लिए अभी भी duoOffice साइन-इन आवश्यक है।',
    setAiSave: 'सहेजें',
    ...
    setAiGskTools: 'duoOffice क्लाउड टूल',
    setAiGskToolsDesc:
      'वेब खोज, AI छवि निर्माण और मीडिया विश्लेषण duoOffice क्लाउड से होते हैं और क्रेडिट खर्च करते हैं; बंद करने पर छवि टूल अनुपलब्ध होंगे और खोज मुफ्त स्रोतों का उपयोग करेगी।',
    setGithub: 'ओपन सोर्स',
    ...
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ duoOffice क्रेडिट**',
    ...
    onbNote3: 'AI सुविधाएँ duoOffice क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'duoOffice Projects',
    cloudSubtitle: '在網頁端用 duoOffice AI 建立的專案。編輯在瀏覽器中繼續——點擊任意專案即可開啟。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入 duoOffice 帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountduoOffice: 'duoOffice 帳號',
    account: '帳號',
    login: '登入',
    loginduoOffice: '登入 duoOffice 帳號',
    loggedIn: '已登入',
    loggedInduoOffice: '已登入 duoOffice',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 duoOffice，請檢查網路或代理設定',
    ...
    setAiduoOfficeHint: '使用 duoOffice 帳號登入，無需 API key。',
    setAiByokNote: '對話使用你自己的 key；網頁搜尋、生圖等雲端工具仍需登入 duoOffice。',
    setAiSave: '儲存',
    setAiSaved: '已儲存',
    setAiTest: '測試連線',
    setAiTesting: '測試中…',
    setAiTestOk: '連線成功',
    setAiTestFail: '連線失敗',
    setAiGskTools: 'duoOffice 雲端工具',
    setAiGskToolsDesc:
      '網頁搜尋、AI 生圖、媒體分析經 duoOffice 雲端並消耗點數；關閉後生圖與媒體分析不可用，搜尋改用免費來源。',
    setGithub: '開源專案',
    ...
    onbCredits: '活躍貢獻者可獲得 **1,000+ duoOffice 點數**',
    onbJoinGenTeam: '加入 GenTeam',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
    ...
    onbNote3: 'AI 功能可能消耗 duoOffice 點數。',
    onbBack: '上一步',
  },
} as const
