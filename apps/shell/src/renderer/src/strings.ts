...
export const strings = {
  zh: {
    ...
    starPromptTitle: '喜欢 duoOffice 吗？',
    starPromptTitleN: '你已经用 duoOffice 打开了 {n} 个文档',
    starPromptBody: 'duoOffice 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 duoOffice，欢迎到 GitHub 给我们一个 Star。',
    setChange: '更改',
    // Dates
    today: '今天',
    yesterday: '昨天',
    ...
    onbTitle1: '欢迎使用 duoOffice',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2:
      'duoOffice 目前处于 alpha 阶段。欢迎加入 GitHub Discussions 群聊，分享反馈，一起塑造它的未来。',
    onbJoinCommunity: '加入 GitHub Discussions',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
  ...
  en: {
    ...
    starPromptTitle: 'Enjoying duoOffice?',
    starPromptTitleN: "You've opened {n} documents with duoOffice",
    starPromptBody:
      'duoOffice is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like duoOffice, give us a star on GitHub.',
    setChange: 'Change',
    today: 'Today',
    yesterday: 'Yesterday',
    daysAgo: '{n}d ago',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to duoOffice',
    ...
    onbBody2:
      'duoOffice is still in alpha. Join the group chat on GitHub Discussions to share feedback and help shape what comes next.',
    onbJoinCommunity: 'Join GitHub Discussions',
    onbSkip: 'Skip',
    onbNext: 'Next',
  ...
  ja: {
    ...
    starPromptTitle: 'duoOffice はいかがですか？',
    starPromptTitleN: 'duoOffice で {n} 件のドキュメントを開きました',
    starPromptBody:
      'duoOffice は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'duoOffice が気に入ったら、GitHub でスターをお願いします。',
    setChange: '変更',
    // Dates
    today: '今日',
    yesterday: '昨日',
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'duoOffice へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'duoOffice はまだアルファ版です。GitHub Discussions のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbJoinCommunity: 'GitHub Discussions に参加',
    onbSkip: 'スキップ',
    onbNext: '次へ',
    onbStart: 'はじめる',
  ...
  ko: {
    ...
    starPromptTitle: 'duoOffice가 마음에 드시나요?',
    starPromptTitleN: 'duoOffice로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'duoOffice는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'duoOffice가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setChange: '변경',
    // Dates
    today: '오늘',
    yesterday: '어제',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'duoOffice에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'duoOffice는 아직 알파 단계입니다. GitHub Discussions 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbJoinCommunity: 'GitHub Discussions 참여하기',
    onbSkip: '건너뛰기',
    onbNext: '다음',
    onbStart: '시작하기',
  ...
  fr: {
    ...
    starPromptTitle: 'duoOffice vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec duoOffice',
    starPromptBody:
      'duoOffice est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si duoOffice vous plaît, mettez-nous une étoile sur GitHub.',
    setChange: 'Modifier',
    // Dates
    today: "Aujourd'hui",
    yesterday: 'Hier',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans duoOffice',
    ...
    onbBody2:
      'duoOffice est encore en alpha. Rejoignez la discussion de groupe sur GitHub Discussions pour partager vos retours et façonner la suite.',
    onbJoinCommunity: 'Rejoindre GitHub Discussions',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
  ...
  de: {
    ...
    starPromptTitle: 'Gefällt Ihnen duoOffice?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit duoOffice geöffnet',
    starPromptBody:
      'duoOffice ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen duoOffice gefällt, geben Sie uns einen Stern auf GitHub.',
    setChange: 'Ändern',
    // Dates
    today: 'Heute',
    yesterday: 'Gestern',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei duoOffice',
    ...
    onbBody2:
      'duoOffice ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GitHub Discussions bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbJoinCommunity: 'GitHub Discussions beitreten',
  ...
  es: {
    ...
    starPromptTitle: '¿Te gusta duoOffice?',
    starPromptTitleN: 'Has abierto {n} documentos con duoOffice',
    starPromptBody:
      'duoOffice es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta duoOffice, danos una estrella en GitHub.',
    setChange: 'Cambiar',
    // Dates
    today: 'Hoy',
    yesterday: 'Ayer',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a duoOffice',
    ...
    onbBody2:
      'duoOffice aún está en alfa. Únete al chat grupal en GitHub Discussions para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbJoinCommunity: 'Unirse a GitHub Discussions',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
  ...
  th: {
    ...
    starPromptTitle: 'ชอบ duoOffice ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย duoOffice ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'duoOffice ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ duoOffice ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setChange: 'เปลี่ยน',
    // Dates
    today: 'วันนี้',
    yesterday: 'เมื่อวาน',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ duoOffice',
    ...
    onbBody2:
      'duoOffice ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GitHub Discussions เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbJoinCommunity: 'เข้าร่วม GitHub Discussions',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
  ...
  id: {
    ...
    starPromptTitle: 'Suka duoOffice?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan duoOffice',
    starPromptBody:
      'duoOffice gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai duoOffice, beri kami bintang di GitHub.',
    setChange: 'Ubah',
    // Dates
    today: 'Hari ini',
    yesterday: 'Kemarin',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di duoOffice',
    ...
    onbBody2:
      'duoOffice masih dalam tahap alpha. Gabung obrolan grup di GitHub Discussions untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbJoinCommunity: 'Gabung GitHub Discussions',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
  ...
  ru: {
    ...
    starPromptTitle: 'Нравится duoOffice?',
    starPromptTitleN: 'Вы уже открыли {n} документов в duoOffice',
    starPromptBody:
      'duoOffice — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится duoOffice, поставьте нам звезду на GitHub.',
    setChange: 'Изменить',
    // Dates
    today: 'Сегодня',
    yesterday: 'Вчера',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в duoOffice',
    ...
    onbBody2:
      'duoOffice пока в альфа-версии. Присоединяйтесь к групповому чату в GitHub Discussions, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbJoinCommunity: 'Присоединиться к GitHub Discussions',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
  ...
  ar: {
    ...
    starPromptTitle: 'هل أعجبك duoOffice؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في duoOffice',
    starPromptBody: 'duoOffice مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك duoOffice، ضع لنا نجمة على GitHub.',
    setChange: 'تغيير',
    // Dates
    today: 'اليوم',
    yesterday: 'أمس',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في duoOffice',
    ...
    onbBody2:
      'لا يزال duoOffice في مرحلة ألفا. انضم إلى الدردشة الجماعية على GitHub Discussions لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbJoinCommunity: 'الانضمام إلى GitHub Discussions',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
  ...
  pt: {
    ...
    starPromptTitle: 'Gostando do duoOffice?',
    starPromptTitleN: 'Você já abriu {n} documentos com o duoOffice',
    starPromptBody:
      'O duoOffice é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do duoOffice, deixe uma estrela no GitHub.',
    setChange: 'Alterar',
    today: 'Hoje',
    yesterday: 'Ontem',
    daysAgo: 'há {n} dias',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao duoOffice',
    ...
    onbBody2:
      'O duoOffice ainda está em alfa. Entre no chat em grupo no GitHub Discussions para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbJoinCommunity: 'Entrar no GitHub Discussions',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
  ...
  it: {
    ...
    starPromptTitle: 'Ti piace duoOffice?',
    starPromptTitleN: 'Hai aperto {n} documenti con duoOffice',
    starPromptBody:
      'duoOffice è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace duoOffice, lasciaci una stella su GitHub.',
    setChange: 'Cambia',
    today: 'Oggi',
    yesterday: 'Ieri',
    daysAgo: '{n} giorni fa',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in duoOffice',
    ...
    onbBody2:
      'duoOffice è ancora in alpha. Unisciti alla chat di gruppo su GitHub Discussions per condividere feedback e contribuire a plasmare il futuro.',
    onbJoinCommunity: 'Unisciti a GitHub Discussions',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
  ...
  pl: {
    ...
    starPromptTitle: 'Podoba Ci się duoOffice?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w duoOffice',
    starPromptBody:
      'duoOffice jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się duoOffice, zostaw nam gwiazdkę na GitHubie.',
    setChange: 'Zmień',
    today: 'Dzisiaj',
    yesterday: 'Wczoraj',
    daysAgo: '{n} dni temu',
    ...
    onbBody2:
      'duoOffice jest wciąż w fazie alfa. Dołącz do czatu grupowego na GitHub Discussions, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbJoinCommunity: 'Dołącz do GitHub Discussions',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
  ...
  nl: {
    ...
    starPromptTitle: 'Bevalt duoOffice?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met duoOffice',
    starPromptBody:
      'duoOffice is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als duoOffice je bevalt, geef ons dan een ster op GitHub.',
    setChange: 'Wijzigen',
    today: 'Vandaag',
    yesterday: 'Gisteren',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij duoOffice',
    ...
    onbBody2:
      'duoOffice is nog in alfa. Doe mee aan de groepschat op GitHub Discussions om feedback te delen en mee te bepalen wat er komt.',
    onbJoinCommunity: 'Word lid van GitHub Discussions',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
  ...
  ms: {
    ...
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan duoOffice',
    starPromptBody:
      'duoOffice percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka duoOffice, beri kami bintang di GitHub.',
    setChange: 'Tukar',
    today: 'Hari ini',
    yesterday: 'Semalam',
    daysAgo: '{n} hari lalu',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke duoOffice',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'duoOffice masih dalam peringkat alfa. Sertai sembang kumpulan di GitHub Discussions untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbJoinCommunity: 'Sertai GitHub Discussions',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
  ...
  he: {
    ...
    starPromptTitle: 'נהנים מ-duoOffice?',
    starPromptTitleN: 'פתחת {n} מסמכים עם duoOffice',
    starPromptBody: 'duoOffice חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם duoOffice מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setChange: 'שינוי',
    today: 'היום',
    yesterday: 'אתמול',
    daysAgo: 'לפני {n} ימים',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-duoOffice',
    ...
    onbBody2:
      'duoOffice עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GitHub Discussions כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbJoinCommunity: 'הצטרפו ל-GitHub Discussions',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
  ...
  hi: {
    ...
    starPromptTitle: 'duoOffice पसंद आ रहा है?',
    starPromptTitleN: 'आपने duoOffice में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'duoOffice मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको duoOffice पसंद है, तो हमें GitHub पर स्टार दें।',
    setChange: 'बदलें',
    today: 'आज',
    yesterday: 'कल',
    daysAgo: '{n} दिन पहले',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'duoOffice में आपका स्वागत है',
    ...
    onbBody2:
      'duoOffice अभी अल्फ़ा में है। GitHub Discussions पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbJoinCommunity: 'GitHub Discussions से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
  ...
  'zh-TW': {
    ...
    starPromptTitle: '喜歡 duoOffice 嗎？',
    starPromptTitleN: '你已經用 duoOffice 開啟了 {n} 個文件',
    starPromptBody: 'duoOffice 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 duoOffice，歡迎到 GitHub 給我們一顆星。',
    setChange: '變更',
    today: '今天',
    yesterday: '昨天',
    daysAgo: '{n} 天前',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 duoOffice',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2:
      'duoOffice 目前仍在 alpha 階段。歡迎加入 GitHub Discussions 群聊，分享回饋，一起打造它的未來。',
    onbJoinCommunity: '加入 GitHub Discussions',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
