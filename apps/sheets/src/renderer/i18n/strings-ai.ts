...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiduoOfficeAccount: 'duoOffice 账号',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: '未登录（AI 功能需要登录 duoOffice 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiLoginduoOffice: '登录 duoOffice',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
  ...
  en: {
    ...
    aiduoOfficeAccount: 'duoOffice account',
    aiAccountChecking: 'Checking…',
    aiLoggedIn: 'Signed in',
    aiLoggedInAs: 'Signed in: {email}',
    aiNotLoggedIn: 'Not signed in (AI features require a duoOffice account)',
    aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
    aiLoginduoOffice: 'Sign in to duoOffice',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
  ...
  ja: {
    ...
    aiduoOfficeAccount: 'duoOffice アカウント',
    aiAccountChecking: '確認中…',
    aiLoggedIn: 'サインイン済み',
    aiLoggedInAs: 'サインイン済み: {email}',
    aiNotLoggedIn: '未サインイン（AI 機能には duoOffice アカウントへのサインインが必要です）',
    aiWaitingBrowserLogin: 'ブラウザーでのサインインを待機中…',
    aiLoginduoOffice: 'duoOffice にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
  ...
  ko: {
    ...
    aiduoOfficeAccount: 'duoOffice 계정',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 duoOffice 계정 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    aiLoginduoOffice: 'duoOffice 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
  ...
  fr: {
    ...
    aiduoOfficeAccount: 'Compte duoOffice',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte duoOffice)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    aiLoginduoOffice: 'Se connecter à duoOffice',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
  ...
  de: {
    ...
    aiduoOfficeAccount: 'duoOffice-Konto',
    aiAccountChecking: 'Wird überprüft…',
    aiLoggedIn: 'Angemeldet',
    aiLoggedInAs: 'Angemeldet: {email}',
    aiNotLoggedIn: 'Nicht angemeldet (KI-Funktionen erfordern ein duoOffice-Konto)',
    aiWaitingBrowserLogin: 'Warten auf Anmeldung im Browser…',
    aiLoginduoOffice: 'Bei duoOffice anmelden',
    aiModel: 'Modell',
    aiCancel: 'Abbrechen',
    aiSave: 'Speichern',
  ...
  es: {
    ...
    aiduoOfficeAccount: 'Cuenta de duoOffice',
    aiAccountChecking: 'Comprobando…',
    aiLoggedIn: 'Sesión iniciada',
    aiLoggedInAs: 'Sesión iniciada: {email}',
    aiNotLoggedIn: 'Sin sesión iniciada (las funciones de IA requieren una cuenta de duoOffice)',
    aiWaitingBrowserLogin: 'Esperando el inicio de sesión en el navegador…',
    aiLoginduoOffice: 'Iniciar sesión en duoOffice',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Guardar',
  ...
  ru: {
    ...
    aiduoOfficeAccount: 'Учётная запись duoOffice',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись duoOffice)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    aiLoginduoOffice: 'Войти в duoOffice',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
  ...
  ar: {
    ...
    aiduoOfficeAccount: 'حساب duoOffice',
    aiAccountChecking: 'جارٍ التحقق…',
    aiLoggedIn: 'تم تسجيل الدخول',
    aiLoggedInAs: 'تم تسجيل الدخول: {email}',
    aiNotLoggedIn: 'لم يتم تسجيل الدخول (تتطلب ميزات الذكاء الاصطناعي حساب duoOffice)',
    aiWaitingBrowserLogin: 'في انتظار تسجيل الدخول من المتصفح…',
    aiLoginduoOffice: 'تسجيل الدخول إلى duoOffice',
    aiModel: 'النموذج',
    aiCancel: 'إلغاء',
    aiSave: 'حفظ',
  ...
  pt: {
    ...
    aiduoOfficeAccount: 'Conta duoOffice',
    aiAccountChecking: 'Verificando…',
    aiLoggedIn: 'Conectado',
    aiLoggedInAs: 'Conectado: {email}',
    aiNotLoggedIn: 'Não conectado (os recursos de IA exigem uma conta duoOffice)',
    aiWaitingBrowserLogin: 'Aguardando login no navegador…',
    aiLoginduoOffice: 'Entrar no duoOffice',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Salvar',
  ...
  nl: {
    ...
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een duoOffice-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    aiLoginduoOffice: 'Aanmelden bij duoOffice',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
  ...
  he: {
    ...
    aiduoOfficeAccount: 'חשבון duoOffice',
    aiAccountChecking: 'בודק…',
    aiLoggedIn: 'מחובר',
    aiLoggedInAs: 'מחובר: {email}',
    aiNotLoggedIn: 'לא מחובר (תכונות AI דורשות חשבון duoOffice)',
    aiWaitingBrowserLogin: 'ממתין לכניסה בדפדפן…',
    aiLoginduoOffice: 'כניסה ל-duoOffice',
    aiModel: 'מודל',
    aiCancel: 'ביטול',
    aiSave: 'שמירה',
  ...
  hi: {
    ...
    aiduoOfficeAccount: 'duoOffice खाता',
    aiAccountChecking: 'जांच हो रही है…',
    aiLoggedIn: 'साइन इन किया गया',
    aiLoggedInAs: 'साइन इन: {email}',
    aiNotLoggedIn: 'साइन इन नहीं है (AI सुविधाओं के लिए duoOffice खाता आवश्यक है)',
    aiWaitingBrowserLogin: 'ब्राउज़र में साइन इन की प्रतीक्षा…',
    aiLoginduoOffice: 'duoOffice में साइन इन करें',
    aiModel: 'मॉडल',
    aiCancel: 'रद्द करें',
    aiSave: 'सहेजें',
  ...
  'zh-TW': {
    ...
    aiduoOfficeAccount: 'duoOffice 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 duoOffice 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiLoginduoOffice: '登入 duoOffice',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
