...
export default defineConfig({
  // @duooffice/i18n ships as TS source; pdf-lib's package only includes out/** — both must be bundled
  main: {
    plugins: [
  ...
  preload: {
    ...
    plugins: [externalizeDepsPlugin({ exclude: ['@duooffice/i18n', '@duooffice/electron-utils'] })],
  },
  renderer: {
    plugins: [
      react(),
