...
import type { Block } from '@duooffice/docx-engine'
import { AgentLoop, composeSkills, type AgentImage } from '@duooffice/agent-core'
...
import { AiComposer, AiTypingIndicator } from '@duooffice/ui'
