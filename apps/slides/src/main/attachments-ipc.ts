...
import { showOpenDialogWithMemory } from '@duooffice/electron-utils'
...
/** office/pdf formats extract text via @duooffice/file-parse; images skip text extraction and go multimodal (slides:files-read-image) */
...
/** Extract attachment text via @duooffice/file-parse (docx/pdf/pptx/xlsx/plain text) */
