...
import type { RenderNode, RenderSlide, ShapeRenderNode } from '@duooffice/pptx-render'
...
function ShowMediaLayer({
  ...
  const nodes = slide.nodes.filter(
    (n): n is import('@duooffice/pptx-render').PictureRenderNode =>
      n.type === 'picture' && !!(n as import('@duooffice/pptx-render').PictureRenderNode).media,
  )
